...
<div class="register-photo" style="height:650px;">
    <div class="form-container">
        ...
        <form method="post" action="/user/register" name="registerForm">
            ...
            <div class="form-group"><input class="form-control" type="text" name="avatar" placeholder="Avatar" style="display:none;"></div>
            <div class="form-group"><input class="form-control" type="file" placeholder="Avatar" id="img-file" value="Select IMG"></div>
